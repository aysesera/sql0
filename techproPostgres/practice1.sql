...
select * from personel where email not like '%@mail.com';

-- 11) id'si 3,5,7 ve 9 olan personel bilgilerini listeleyiniz.
select * from personel where id in(3,5,7,9);--IN() icine aynı degiskene ait birden fazla 
...
select * from personel order by yas asc;--dogal sıralama kucukten buyuge
