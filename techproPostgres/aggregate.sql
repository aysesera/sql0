...
SELECT round(avg(maas)) from calisanlar2-- round kusuratı yok etmek icin kullanılır
...
WHERE maas < (SELECT max(maas) from calisanlar2)-- yalnız  sart olarak maas birinciden kucukse yaz
